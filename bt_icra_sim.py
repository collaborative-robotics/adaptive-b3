#
#   Basic humanoid robot with three terrains
#    includes the Greedy selector
#
#  Based on the fire extinguisher scenario from Periera and Engel 2015
#
...
valid_arg = False
if arg in ['S0', 'S1', 'S2', 'S2g', 'S3', 'S4', 'S5' ]:
    valid_arg = True
